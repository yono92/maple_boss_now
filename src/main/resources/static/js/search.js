document.addEventListener("DOMContentLoaded", () => {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-lg font-medium text-blue-500 dark:text-blue-400 cursor-pointer" id="guild-name" data-world="${basicInfo.world_name}">${basicInfo.character_guild_name}</p>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
    ...
    // 길드 이름 클릭 이벤트 핸들러 추가
    document.getElementById('guild-name').addEventListener('click', () => {
        const guildName = basicInfo.character_guild_name;
